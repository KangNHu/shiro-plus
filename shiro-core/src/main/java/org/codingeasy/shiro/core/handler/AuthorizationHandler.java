...
public interface AuthorizationHandler {
	...
	default Logical getLogical(PermissionMetadata permissionMetadata){
		org.codingeasy.shiro.core.metadata.Logical logical = permissionMetadata.getLogical();
		return logical == null ?
				Logical.AND :
				org.codingeasy.shiro.core.metadata.Logical.AND == logical ? Logical.AND :Logical.OR;
	}
}
